            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-10">
                ...
                <section className="py-8 md:py-16 max-w-3xl">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <a href="/Vishnu_A_FullStack_Resume_Bengaluru.pdf" target="_blank" aria-label="Download Vishnu's Full-Stack Resume in PDF format" className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 px-6 py-3 rounded-lg font-medium text-sm transition-all">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-slate-900/30 border border-slate-800 rounded-xl p-6 md:col-span-2 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 hover:border-emerald-500/40 transition-all group">
                            ...
                            <div className="flex flex-col sm:items-end gap-2 shrink-0 w-full sm:w-auto font-mono text-xs">
                                <a href="https://github.com/vish-vishnu" target="_blank" rel="noreferrer" aria-label="View Micro Credit Ledger project source code on GitHub" className="bg-slate-800 hover:bg-slate-700 text-slate-200 px-4 py-2.5 rounded-lg flex items-center justify-center gap-2 transition-colors">
                                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
                                </a>
                                <a href="#" aria-label="Open live demo of Micro credit Application" className="hover:text-purple-400"><ExternalLink className="w-4 h-4" /></a>
                                <span className="text-[11px] text-slate-400 text-center sm:text-right mt-1">React • MySQL • JWT</span>
                            </div>
                        </div>
                    </div>
                </section>
